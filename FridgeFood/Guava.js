    ...
    <>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={styles.cell}>
          <Text style={{ fontSize: 25, textAlign: 'center', fontWeight: '600' }}>芭樂</Text>
        </View>
        <View style={styles.cell_fixed}>
          {/* 右上按鈕空間 */}
        </View>
      ...
      <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 50 }}>
        <View style={styles.body_image}>
          <Image source={require('../assets/FridgeFood/guava.png')} style={{ height: 190, width: 190 }} />
        </View>

        <View style={styles.boxcontainer}>
          <View style={styles.textbox}>
            <Text style={{ fontSize: 20 }}>放入時間::</Text>
            <Text style={{ fontSize: 20 }}>2020/3/6</Text>
          </View>
          <View style={styles.textbox}>
        ...
        <View style={styles.boxcontainer}>
          <View style={styles.textbox}>
            ...
            <Text style={{ fontSize: 20 }}>6 顆</Text>
          </View>
          <View style={styles.textbox}>
            <Text style={{ fontSize: 20 }}>熱量評估:</Text>
            <Text style={{ fontSize: 20 }}>60 kcal</Text>
          </View>
        </View>
      </View>
    </>
