    ...
    <>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={styles.cell}>
          <Text style={{ fontSize: 25, textAlign: 'center', fontWeight: '600' }}>鳳梨</Text>
        </View>
        <View style={styles.cell_fixed}>
          {/* 右上按鈕空間 */}
        </View>
      ...
      <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 50 }}>
        <View style={styles.body_image}>
          <Image source={require('../assets/FridgeFood/pineapple.png')} style={{ height: 190, width: 190 }} />
        </View>
        ...
        <View style={styles.boxcontainer}>
          ...
          <View style={styles.textbox}>
            ...
            <Text style={{ fontSize: 20 }}>10 天</Text>
          </View>
        </View>
        ...
        <View style={styles.boxcontainer}>
          <View style={styles.textbox}>
            ...
            <Text style={{ fontSize: 20 }}>1 顆</Text>
          </View>
          <View style={styles.textbox}>
            <Text style={{ fontSize: 20 }}>熱量評估:</Text>
            <Text style={{ fontSize: 20 }}>270 kcal</Text>
          </View>
        </View>
      </View>
    </>
