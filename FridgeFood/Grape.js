    ...
    <>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View style={styles.cell}>
          <Text style={{ fontSize: 25, textAlign: 'center', fontWeight: '600' }}>葡萄</Text>
        </View>
        <View style={styles.cell_fixed}>
          {/* 右上按鈕空間 */}
        </View>
      ...
      <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 50 }}>
        <View style={styles.body_image}>
          <Image source={require('../assets/FridgeFood/grape.jpg')} style={{ height: 190, width: 190 }} />
        </View>
        ...
        <View style={styles.boxcontainer}>
          <View style={styles.textbox}>
            ...
            <Text style={{ fontSize: 20 }}>3 串</Text>
          </View>
          <View style={styles.textbox}>
            <Text style={{ fontSize: 20 }}>熱量評估:</Text>
            <Text style={{ fontSize: 20 }}>180 kcal</Text>
          </View>
        </View>
      </View>
    </>
